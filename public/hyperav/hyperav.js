...
function loadDependencies() {
  return new Promise((resolve, reject) => {
    ...
    threeScript.onload = () => {
      // Load HyperAV core files after Three.js
      Promise.all([
        loadScript('/hyperav/core/dimensional-gateway.js'),
        loadScript('/hyperav/core/hypercube.js'),
        loadScript('/hyperav/core/quantum-field.js'),
        loadScript('/hyperav/hyperav-loader.js'),
        loadCSS('/hyperav/hyperav.css')
      ])
      .then(resolve)
      .catch(reject);
    };
