...
async function initializeHyperAV() {
  ...
  try {
    ...
    const ShaderManager = (await import('./core/ShaderManager.js')).default;
    const HypercubeCore = (await import('./core/HypercubeCore.js')).default;
    const SoundInterface = (await import('./sound/SoundInterface.js')).default;
    
    // Initialize ShaderManager
    const shaderManager = new ShaderManager(canvas.getContext('webgl'));
